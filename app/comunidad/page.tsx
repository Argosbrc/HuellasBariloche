  ...
  return (
    <main className="inner-shell">
      ...
      <section className="inner-hero community-hero">
        <div><span className="section-kicker">Comunidad Huellas</span><h1>Una patita<em>una accion.</em></h1><p>Un espacio para pedir una mano, convocar personas, ofrecer recursos y compartir información útil.</p><Link className="button button-white button-large" href={publishHref}><MessageCircle size={18} />Publicar en Comunidad</Link></div>

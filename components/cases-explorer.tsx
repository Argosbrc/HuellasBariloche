...
export function CasesExplorer({ cases }: { cases: CaseWithImage[] }) {
  ...
  const visible = useMemo(() => {
    ...
    return cases.filter((item) => {
      ...
      const matchesType =
        filter === "all" || item.post_type === filter;
    ...
    <>
      ...
      <div className="directory-toolbar">
        ...
        <label className="search-field">
          ...
          <input
            ...
            placeholder="Nombre, raza o barrio"
          />
        ...
        <div
          className="filter-row inner-filters"
          role="group"
      ...
      <section className="inner-content">
        ...
        <div className="results-heading">
          ...
          <div>
            <strong>{visible.length} casos visibles</strong>
            <span>Ubicaciones públicas aproximadas.</span>
          </div>
        ...
        {visible.length ? (
          ...
          <div className="directory-grid">
            ...
            {visible.map((item) => {
              ...
              const Icon =
                item.species?.toLowerCase().includes("gat")
                  ? Cat
                  : Dog;
                ...
                >
                  ...
                  <div className={`directory-image case-${accent}`}>
                    ...
                    <span className={`status status-${accent}`}>
                      {labelFor(item.post_type)}
                    </span>


                    <span className="approx-label">
                      <MapPin size={12} />
                  ...
                  <div className="directory-body">
                    ...
                    <div className="directory-meta">
                      ...
                      <span>
                        {item.sighting_count} avistamientos
                      </span>
                    ...
                    <span className="case-detail-link">
                      Ver ficha y contacto
                    </span>
          ...
          <div className="empty-state">
            ...
            <span>
              Probá otra búsqueda o volvé a “Todos”.
            </span>
